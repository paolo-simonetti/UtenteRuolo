	...
	<main role="main" class="container">
		...
		<div class='card'>
		    ...
		    <div class='card-body'>
					...
					<form method="post" action="PrepareDeleteCategoriaDaDropdownServlet" novalidate="novalidate">
					
						<div class="form-row">
							<div class="form-group col-md-6">
								<label>Id categoria </label>
								<input type="number" name="idCategoriaDaEliminare" id="idCategoriaDaEliminare" 
