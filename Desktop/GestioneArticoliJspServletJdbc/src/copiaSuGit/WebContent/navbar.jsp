    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdown01">
          ...
          <a class="dropdown-item" href="updateDaDropdown.jsp">Aggiorna elemento</a>
          <a class="dropdown-item" href="deleteDaDropdown.jsp">Elimina elemento</a>
          <a class="dropdown-item" href="getDaDropdown.jsp">Visualizza elemento</a>
        </div>
      </li>
    </ul>
