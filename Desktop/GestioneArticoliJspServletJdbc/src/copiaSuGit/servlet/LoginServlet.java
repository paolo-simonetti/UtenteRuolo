...
public class LoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (utenteIsRegistrato) {
			request.setAttribute("nomeUtente",utenteIdentificato.getNome());
			request.setAttribute("cognomeUtente",utenteIdentificato.getCognome());
			request.setAttribute("codiceFiscaleUtente",utenteIdentificato.getCodiceFiscale());
